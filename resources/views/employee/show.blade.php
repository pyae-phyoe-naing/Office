            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <p class="text-muted mb-0">{{ ucfirst($employee->address) }}</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <p class="mb-0"><i class="fab fa-gg"></i> Department</p>
                        <p class="text-muted mb-0">{{ $employee->department ? $employee->department->title : '-' }}
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <p class="text-muted mb-0">{{ $employee->date_of_join }}
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
