        ...
        <div class="card-body">
            <form action="{{ route('employee.update', $employee->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="md-form">
                    ...
                    <input type="text" name="birthday" value="{{ $employee->birthday }}" class="form-control"
                        id='birthday'>
                </div>

                <div class="md-form">
                    <label for="">Date Of Join</label>
                    <input type="text" name="date_of_join" value="{{ $employee->date_of_join }}" class="form-control"
                        id='date_of_join'>
                </div>
                <div class="md-form">
